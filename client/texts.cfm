...
help.cfh.closed.resolved=Thank you, your issue has now been resolved.
...
hotel_merge.name_change.info.select=You can search for available names, and pick the one that is available.
...
help.button.habboway.url=http://www.habbo.com/groups/officialhabboway
help.button.faq.topiclist=Go back to list of topics
link.help.habboway=http://%predefined%/groups/HabboWay
...
help.mainpage.topics.title=Known issues, read these first:
...
help.tutorial.info=Welcome to Habbo Hotel! Here are some tasks to help you get started.
...
help.tutorial.guidebot.info=You can call a Guide bot to your own room from the Habbo Help menu by clicking the question mark on the left hand toolbar. Feel free to ask the robot any questions you might have, but remember, robot might not know everything.
help.cfh.error.title=Your call for help was not sent!
help.cfh.reply.title=Your call has been responded to as follows:
help.button.habboway=Habbo Way: How to play Habbo according to the Habbo Way >>
...
hotel_merge.name_change.info.main=In preparation for the relaunch of Habbo.com some users with name that conflicts between hotels have to change their name. You are one of these users. You can change your character name only once, so think carefully what name you want.
...
catalog.alert.notenough.pixels.title=Not Enough Pixels!
...
catalog.page.club=Buy Habbo Club
...
friendlist.listfull.text=Your friend list contains the maximum amount of Habbos, so you cannot add any more friends. The maximum amount for regular users is %mylimit% and %clublimit% for Habbo Club members.
...
facebook.story.achievement.caption={0} just unlocked an Achievement badge in Habbo Hotel.
...
notifications.text.achievement=Congratulations! You unlocked the %badge_name% Achievement! (%badge_desc%)
...
inventory.achievements.entrydetails=Progress: %currentpoints%/%scorelimit% %unit%, Reward: %levelrewardpoints% pixels
...
nav_venue_netcafe/0_desc=Ask all your gaming questions to our special guest (VIP Neil Long) 4:30PM UK time on Wednesday the 29th September.
...
nav_venue_theatredrome/0_desc=Rock the Schools powered by A Brand Called Ed visits 70 schools each year from May until August. 
...
nav_venue_park/0_desc=The Infobus is here
...
nav_venue_branded/0_desc=Can you master the challenge of the Ancient Olympians? Find out at Mount Olympus!
...
nav_venue_tv_studio_3/0_desc=Support your favorite artists! Vote for them right now and you could win a Trophy.
...
nav_venue_picnic/0_desc=Bring good food and good friends for an awesome time in the sun!
...
nav_venue_habbo_lido_ii/0_desc=There's a Poll in the Pool! You can do it!
...
nav_venue_library/0_name=Library
...
nav_venue_theatredrome_xmas/0_desc=The holidays are finally here!
...
nav_venue_sunset_cafe/0_name=Sunset Cafe
...
nav_venue_theatredrome/0_name=Rock the Schools Assembly
...
nav_venue_tv_studio_2/0_desc=Join the MTV UK group in Habbo Hotel to get an exclusive virtual MTV web sticker as well as the latest celeb news and gossip!
...
nav_venue_library/0_desc=There's nothing like a good book...
...
nav_venue_sunset_cafe/0_desc=Let yourself be lulled by the gentle pixel waves...
...
nav_venue_star_lounge/0_desc=Come in and have a chat and a dance!
...
nav_venue_habbo_cinema/0_desc=Enjoy your time in the prime!
nav_venue_picnic_dudesons/0_desc=
nav_venue_netcafe/0_name=Golden Joystick Net Cafe
...
nav_venue_beauty_salon_general/0_desc=Treat yourself to a day of beauty!
...
nav_venue_branded/0_name=Mount Olympus
...
nav_venue_the_chromide_club/0_desc=All styles, all beats, all comers.  Tables in the front room, dance floor in the back.
...
nav_venue_star_lounge/0_name=Street Dance 3D Star Lounge
